...
CREATE NONCLUSTERED INDEX [IX_Clientes_BairroID]
    ON [dbo].[Clientes]([BairroID] ASC);
CREATE NONCLUSTERED INDEX [IX_Clientes_CidadeID]
    ON [dbo].[Clientes]([CidadeID] ASC);
CREATE NONCLUSTERED INDEX [IX_Clientes_RuaID]
    ON [dbo].[Clientes]([RuaID] ASC);
GO
...
CREATE NONCLUSTERED INDEX [IX_LivroCategoria_CategoriaID]
    ON [dbo].[LivroCategoria]([CategoriaID] ASC);
CREATE NONCLUSTERED INDEX [IX_LivroCategoria_LivroID]
    ON [dbo].[LivroCategoria]([LivroID] ASC);
